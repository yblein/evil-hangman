...
var _yblein$evil_hangman$EvilHangman$onKeyPress = function (tagger) {
	return A2(
		_elm_lang$html$Html_Events$on,
		'keyup',
		A2(_elm_lang$core$Json_Decode$map, tagger, _elm_lang$html$Html_Events$keyCode));
};
var _yblein$evil_hangman$EvilHangman$failedAttemps = function (gameData) {
	var correctAttemps = _elm_lang$core$Array$toList(gameData.solution);
	return A2(
		...
		gameData.previousGuesses);
};
var _yblein$evil_hangman$EvilHangman$makeCharList = function (_p0) {
	return A2(
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$String$fromChar(s))
						]));
			},
			_p0));
};
var _yblein$evil_hangman$EvilHangman$viewCurrentSolution = function (_p1) {
	return _yblein$evil_hangman$EvilHangman$makeCharList(
		A2(
			_elm_lang$core$List$map,
...
var _yblein$evil_hangman$EvilHangman$shuffle = function (xs) {
	var sortBy = function (fs) {
		return A2(
			_elm_lang$core$List$map,
	...
	return A2(_elm_lang$core$Random$map, sortBy, genFloats);
};
var _yblein$evil_hangman$EvilHangman$isJust = function (m) {
	var _p2 = m;
	if (_p2.ctor === 'Nothing') {
		return false;
	} else {
...
var _yblein$evil_hangman$EvilHangman$minimumBy = function (f) {
	return function (_p3) {
		return _elm_lang$core$List$head(
			A2(_elm_lang$core$List$sortWith, f, _p3));
	};
};
var _yblein$evil_hangman$EvilHangman$updateSolution = F2(
	function (indexes, $char) {
		return _elm_lang$core$Array$indexedMap(
			F2(
				function (i, mc) {
					return A2(_elm_lang$core$List$member, i, indexes) ? _elm_lang$core$Maybe$Just($char) : mc;
				}));
	});
var _yblein$evil_hangman$EvilHangman$minInformation = F2(
	function (_p5, _p4) {
		var _p6 = _p5;
		var _p7 = _p4;
		var _p8 = A2(
			...
			_elm_lang$core$List$length(_p7._1));
		switch (_p8.ctor) {
			case 'GT':
...
var _yblein$evil_hangman$EvilHangman$computeWordFamilies = F2(
	function (words, $char) {
		var insertWord = F2(
			function (word, families) {
				var indexes = A2(
					_elm_lang$core$String$indexes,
					_elm_lang$core$String$fromChar($char),
					word);
				var _p9 = A2(_elm_lang$core$Dict$get, indexes, families);
				if (_p9.ctor === 'Just') {
					return A3(
						_elm_lang$core$Dict$insert,
						indexes,
						A2(_elm_lang$core$List_ops['::'], word, _p9._0),
						families);
				} else {
					return A3(
						_elm_lang$core$Dict$insert,
		...
		return _elm_lang$core$Dict$toList(
			A3(_elm_lang$core$List$foldl, insertWord, _elm_lang$core$Dict$empty, words));
	});
var _yblein$evil_hangman$EvilHangman$nbGuesses = 10;
var _yblein$evil_hangman$EvilHangman$maxLetters = 9;
var _yblein$evil_hangman$EvilHangman$minLetters = 4;
var _yblein$evil_hangman$EvilHangman$Model = F2(
	function (a, b) {
		return {dictionnary: a, state: b};
	});
var _yblein$evil_hangman$EvilHangman$GameData = F4(
	function (a, b, c, d) {
		return {words: a, solution: b, previousGuesses: c, nbRemGuesses: d};
	});
var _yblein$evil_hangman$EvilHangman$handleChar = F2(
	function (gameData, $char) {
		var _p10 = A2(
			_yblein$evil_hangman$EvilHangman$minimumBy,
			_yblein$evil_hangman$EvilHangman$minInformation,
			A2(_yblein$evil_hangman$EvilHangman$computeWordFamilies, gameData.words, $char));
		if (_p10.ctor === 'Nothing') {
			return gameData;
		} else {
			var newPreviousGuesses = A2(_elm_lang$core$List_ops['::'], $char, gameData.previousGuesses);
			var newSolution = A3(_yblein$evil_hangman$EvilHangman$updateSolution, _p10._0._0, $char, gameData.solution);
			var correct = !_elm_lang$core$Native_Utils.eq(newSolution, gameData.solution);
			var newNbRemGuesses = gameData.nbRemGuesses - (correct ? 0 : 1);
			return A4(_yblein$evil_hangman$EvilHangman$GameData, _p10._0._1, newSolution, newPreviousGuesses, newNbRemGuesses);
		}
	});
var _yblein$evil_hangman$EvilHangman$GameOver = function (a) {
	return {ctor: 'GameOver', _0: a};
};
var _yblein$evil_hangman$EvilHangman$Won = {ctor: 'Won'};
var _yblein$evil_hangman$EvilHangman$Playing = function (a) {
	return {ctor: 'Playing', _0: a};
};
var _yblein$evil_hangman$EvilHangman$start = F2(
	function (model, nbLetters) {
		var initialSolution = A2(_elm_lang$core$Array$repeat, nbLetters, _elm_lang$core$Maybe$Nothing);
		var initialWords = A2(
			_elm_lang$core$List$filter,
			function (w) {
				return _elm_lang$core$Native_Utils.eq(
			...
			model.dictionnary);
		var gameData = A4(
			_yblein$evil_hangman$EvilHangman$GameData,
			initialWords,
			initialSolution,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_yblein$evil_hangman$EvilHangman$nbGuesses);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				state: _yblein$evil_hangman$EvilHangman$Playing(gameData)
			});
	});
var _yblein$evil_hangman$EvilHangman$Ready = {ctor: 'Ready'};
var _yblein$evil_hangman$EvilHangman$Loading = {ctor: 'Loading'};
var _yblein$evil_hangman$EvilHangman$NoOp = {ctor: 'NoOp'};
var _yblein$evil_hangman$EvilHangman$noOp = _elm_lang$core$Basics$always(_yblein$evil_hangman$EvilHangman$NoOp);
var _yblein$evil_hangman$EvilHangman$Solution = function (a) {
	return {ctor: 'Solution', _0: a};
};
var _yblein$evil_hangman$EvilHangman$KeyPressed = function (a) {
	return {ctor: 'KeyPressed', _0: a};
};
var _yblein$evil_hangman$EvilHangman$Randomized = function (a) {
	return {ctor: 'Randomized', _0: a};
};
var _yblein$evil_hangman$EvilHangman$update = F2(
	function (msg, model) {
		var _p11 = {ctor: '_Tuple2', _0: msg, _1: model.state};
		_v6_5:
		do {
				...
				switch (_p11._0.ctor) {
					case 'FetchSucceed':
						return {
							ctor: '_Tuple2',
							_0: A2(
								_yblein$evil_hangman$EvilHangman$Model,
								_elm_lang$core$String$lines(_p11._0._0),
								_yblein$evil_hangman$EvilHangman$Ready),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'Start':
						var genDict = _yblein$evil_hangman$EvilHangman$shuffle(model.dictionnary);
						var genNbLetters = A2(_elm_lang$core$Random$int, _yblein$evil_hangman$EvilHangman$minLetters, _yblein$evil_hangman$EvilHangman$maxLetters);
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(
								_elm_lang$core$Random$generate,
								_yblein$evil_hangman$EvilHangman$Randomized,
								A2(_elm_lang$core$Random$pair, genNbLetters, genDict))
						};
					case 'Randomized':
						if (_p11._0._0.ctor === '_Tuple2') {
							return {
								ctor: '_Tuple2',
								_0: A2(
									_yblein$evil_hangman$EvilHangman$start,
									_elm_lang$core$Native_Utils.update(
										model,
										{dictionnary: _p11._0._0._1}),
									_p11._0._0._0),
								_1: A3(
									_elm_lang$core$Task$perform,
									_yblein$evil_hangman$EvilHangman$noOp,
									_yblein$evil_hangman$EvilHangman$noOp,
					...
					case 'KeyPressed':
						if (_p11._1.ctor === 'Playing') {
							var _p12 = _p11._1._0;
							var c = _elm_lang$core$Char$toLower(
								_elm_lang$core$Char$fromCode(_p11._0._0));
							if (_elm_lang$core$Char$isLower(c) && _elm_lang$core$Basics$not(
								A2(_elm_lang$core$List$member, c, _p12.previousGuesses))) {
								var newGameData = A2(_yblein$evil_hangman$EvilHangman$handleChar, _p12, c);
								return A2(
									_elm_lang$core$List$all,
									_yblein$evil_hangman$EvilHangman$isJust,
									_elm_lang$core$Array$toList(newGameData.solution)) ? {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{state: _yblein$evil_hangman$EvilHangman$Won}),
									_1: _elm_lang$core$Platform_Cmd$none
								} : (_elm_lang$core$Native_Utils.eq(newGameData.nbRemGuesses, 0) ? {
									ctor: '_Tuple2',
									_0: model,
									_1: A2(
										_elm_lang$core$Random$generate,
										_yblein$evil_hangman$EvilHangman$Solution,
										_elm_community$random_extra$Random_Extra$sample(_p12.words))
								} : {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											state: _yblein$evil_hangman$EvilHangman$Playing(newGameData)
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								});
							} else {
					...
					case 'Solution':
						if (_p11._0._0.ctor === 'Just') {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										state: _yblein$evil_hangman$EvilHangman$GameOver(_p11._0._0._0)
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						} else {
...
var _yblein$evil_hangman$EvilHangman$Start = {ctor: 'Start'};
var _yblein$evil_hangman$EvilHangman$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Evil Hangman')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('This is an implementation of the classic Hangman game. It features only simple and common english words like \"boat\" or \"forest\", it should be fairly easy.')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
						...
						case 'Ready':
							return _elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Events$onClick(_yblein$evil_hangman$EvilHangman$Start)
										]),
									_elm_lang$core$Native_List.fromArray(
										[
						...
						case 'Playing':
							...
							return _elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_yblein$evil_hangman$EvilHangman$viewCurrentSolution(_p14.solution)
										])),
									A2(
									_elm_lang$html$Html$p,
									_elm_lang$core$Native_List.fromArray(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$core$Native_List.fromArray(
												[
													_yblein$evil_hangman$EvilHangman$makeCharList(
													_elm_lang$core$List$reverse(
														_yblein$evil_hangman$EvilHangman$failedAttemps(_p14)))
												]))
										])),
									A2(
									_elm_lang$html$Html$p,
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('You have '),
											_elm_lang$html$Html$text(
											_elm_lang$core$Basics$toString(_p14.nbRemGuesses)),
											_elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												' remaining guess',
												A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Native_Utils.eq(_p14.nbRemGuesses, 1) ? '' : 'es',
													'.')))
										])),
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_yblein$evil_hangman$EvilHangman$onKeyPress(_yblein$evil_hangman$EvilHangman$KeyPressed),
						...
						case 'GameOver':
							return _elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Replay')
										]))
								]);
						default:
							return _elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('You won!')
										])),
									A2(
									_elm_lang$html$Html$button,
									_elm_lang$core$Native_List.fromArray(
...
var _yblein$evil_hangman$EvilHangman$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _yblein$evil_hangman$EvilHangman$FetchSucceed = function (a) {
	return {ctor: 'FetchSucceed', _0: a};
};
var _yblein$evil_hangman$EvilHangman$init = {
	ctor: '_Tuple2',
	_0: A2(
		_yblein$evil_hangman$EvilHangman$Model,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_yblein$evil_hangman$EvilHangman$Loading),
	_1: A3(
		_elm_lang$core$Task$perform,
		_yblein$evil_hangman$EvilHangman$FetchFail,
		_yblein$evil_hangman$EvilHangman$FetchSucceed,
		_evancz$elm_http$Http$getString('dict.txt'))
};
var _yblein$evil_hangman$EvilHangman$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _yblein$evil_hangman$EvilHangman$init,
			view: _yblein$evil_hangman$EvilHangman$view,
			update: _yblein$evil_hangman$EvilHangman$update,
			subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
		})
};

var Elm = {};
Elm['EvilHangman'] = Elm['EvilHangman'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['EvilHangman'], 'EvilHangman', typeof _yblein$evil_hangman$EvilHangman$main === 'undefined' ? null : _yblein$evil_hangman$EvilHangman$main);
